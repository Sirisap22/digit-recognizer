    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "svelte-1yid43g");
    			add_location(h10, file$3, 121, 0, 4285);
    			attr_dev(p0, "id", "writenum");
    			attr_dev(p0, "class", "svelte-1yid43g");
    			add_location(p0, file$3, 122, 4, 4351);
    			add_location(h11, file$3, 122, 0, 4347);
    			attr_dev(p1, "id", "predictionResult");
    			attr_dev(p1, "class", "svelte-1yid43g");
    			add_location(p1, file$3, 123, 0, 4396);
    			attr_dev(p2, "id", "arrowbody");
    			attr_dev(p2, "class", "svelte-1yid43g");
    			add_location(p2, file$3, 124, 0, 4443);
    			attr_dev(p3, "id", "triangle");
    			attr_dev(p3, "class", "svelte-1yid43g");
    			add_location(p3, file$3, 125, 0, 4466);
    			attr_dev(p4, "id", "accuracy");
    			attr_dev(p4, "class", "svelte-1yid43g");
    			add_location(p4, file$3, 126, 0, 4488);
    			attr_dev(canvas_1, "width", "500");
    			attr_dev(canvas_1, "height", "400");
    			attr_dev(canvas_1, "id", "canvasW");
    			attr_dev(canvas_1, "class", "svelte-1yid43g");
    			add_location(canvas_1, file$3, 128, 0, 4615);
    			add_location(div0, file$3, 120, 0, 4279);
    			attr_dev(button0, "id", "ButtonClear");
    			attr_dev(button0, "class", "svelte-1yid43g");
    			add_location(button0, file$3, 132, 2, 4718);
    			attr_dev(button1, "id", "ButtonPredict");
    			attr_dev(button1, "class", "svelte-1yid43g");
    			add_location(button1, file$3, 133, 2, 4781);
    			add_location(div1, file$3, 130, 0, 4689);
    			attr_dev(div2, "id", "tabbar");
    			attr_dev(div2, "class", "svelte-1yid43g");
    			add_location(div2, file$3, 119, 0, 4261);
    			attr_dev(body, "id", "pagePrediction");
    			attr_dev(body, "class", "svelte-1yid43g");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1x9w42o");
    			add_location(h1, file$1, 10, 2, 525);
    			attr_dev(div, "id", "box");
    			attr_dev(div, "class", "svelte-1x9w42o");
    			add_location(div, file$1, 9, 2, 508);
    			attr_dev(button, "id", "ButtonGraph");
    			attr_dev(button, "class", "svelte-1x9w42o");
