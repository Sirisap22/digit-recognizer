    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "svelte-jcrayg");
    			add_location(h10, file$3, 121, 0, 4285);
    			attr_dev(p0, "id", "writenum");
    			attr_dev(p0, "class", "svelte-jcrayg");
    			add_location(p0, file$3, 123, 4, 4352);
    			add_location(h11, file$3, 123, 0, 4348);
    			attr_dev(p1, "id", "predictionResult");
    			attr_dev(p1, "class", "svelte-jcrayg");
    			add_location(p1, file$3, 124, 0, 4397);
    			attr_dev(p2, "id", "arrowbody");
    			attr_dev(p2, "class", "svelte-jcrayg");
    			add_location(p2, file$3, 125, 0, 4444);
    			attr_dev(p3, "id", "triangle");
    			attr_dev(p3, "class", "svelte-jcrayg");
    			add_location(p3, file$3, 126, 0, 4467);
    			attr_dev(p4, "id", "accuracy");
    			attr_dev(p4, "class", "svelte-jcrayg");
    			add_location(p4, file$3, 127, 0, 4489);
    			attr_dev(canvas_1, "width", "500");
    			attr_dev(canvas_1, "height", "400");
    			attr_dev(canvas_1, "id", "canvasW");
    			attr_dev(canvas_1, "class", "svelte-jcrayg");
    			add_location(canvas_1, file$3, 129, 0, 4616);
    			add_location(div0, file$3, 120, 0, 4279);
    			attr_dev(button0, "id", "ButtonClear");
    			attr_dev(button0, "class", "svelte-jcrayg");
    			add_location(button0, file$3, 133, 2, 4719);
    			attr_dev(button1, "id", "ButtonPredict");
    			attr_dev(button1, "class", "svelte-jcrayg");
    			add_location(button1, file$3, 134, 2, 4782);
    			add_location(div1, file$3, 131, 0, 4690);
    			attr_dev(div2, "id", "tabbar");
    			attr_dev(div2, "class", "svelte-jcrayg");
    			add_location(div2, file$3, 119, 0, 4261);
    			attr_dev(body, "id", "pagePrediction");
    			attr_dev(body, "class", "svelte-jcrayg");
