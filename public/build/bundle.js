...
var app = (function () {
    ...
    const selectedModel = writable('svm');

    /* src\ModelSelector.svelte generated by Svelte v3.43.1 */

    const { console: console_1 } = globals;
    const file$4 = "src\\ModelSelector.svelte";
    ...
    // (16:3) {#each models as model}
    function create_each_block$1(ctx) {
    	let option;
    	let t0_value = /*model*/ ctx[4].text + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			option.__value = /*model*/ ctx[4];
    			option.value = option.__value;
    			add_location(option, file$4, 16, 5, 480);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:3) {#each models as model}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(select, file$4, 14, 1, 390);
    			attr_dev(div, "id", "select");
    			attr_dev(div, "class", "svelte-oaz7wi");
    			add_location(div, file$4, 13, 6, 371);
    			add_location(main, file$4, 13, 0, 365);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(select, "change", /*onSelectModel*/ ctx[2], false, false, false)
    				];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	validate_slots('ModelSelector', slots, []);
    	let selected;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<ModelSelector> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('models' in $$props) $$invalidate(1, models = $$props.models);
    	};
    	...
    	return [selected, models, onSelectModel, select_change_handler];
    }

    class ModelSelector extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_fragment$3(ctx) {
    	...
    	? `Probability: ${/*$predictionPercentage*/ ctx[0][/*predictedAnswer*/ ctx[4]]}%`
    	: '') + "";
    	...
    	let button1;
    	let current;
    	modelselector = new ModelSelector({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			t14 = space();
    			div1 = element("div");
    			create_component(modelselector.$$.fragment);
    			t15 = space();
    			...
    			add_location(link2, file$3, 115, 0, 3932);
    			...
    			add_location(link3, file$3, 116, 0, 4069);
    			attr_dev(h10, "id", "handWrite");
    			attr_dev(h10, "class", "svelte-1gisas9");
    			add_location(h10, file$3, 121, 0, 4285);
    			attr_dev(p0, "id", "writenum");
    			attr_dev(p0, "class", "svelte-1gisas9");
    			add_location(p0, file$3, 123, 4, 4370);
    			add_location(h11, file$3, 123, 0, 4366);
    			attr_dev(p1, "id", "predictionResult");
    			attr_dev(p1, "class", "svelte-1gisas9");
    			add_location(p1, file$3, 124, 0, 4415);
    			attr_dev(p2, "id", "arrowbody");
    			attr_dev(p2, "class", "svelte-1gisas9");
    			add_location(p2, file$3, 125, 0, 4462);
    			attr_dev(p3, "id", "triangle");
    			attr_dev(p3, "class", "svelte-1gisas9");
    			add_location(p3, file$3, 126, 0, 4485);
    			attr_dev(p4, "id", "accuracy");
    			attr_dev(p4, "class", "svelte-1gisas9");
    			add_location(p4, file$3, 127, 0, 4507);
    			attr_dev(canvas_1, "width", "500");
    			attr_dev(canvas_1, "height", "400");
    			attr_dev(canvas_1, "id", "canvasW");
    			attr_dev(canvas_1, "class", "svelte-1gisas9");
    			add_location(canvas_1, file$3, 129, 0, 4634);
    			attr_dev(div0, "id", "makemid");
    			attr_dev(div0, "class", "svelte-1gisas9");
    			add_location(div0, file$3, 122, 0, 4347);
    			attr_dev(button0, "id", "ButtonClear");
    			attr_dev(button0, "class", "svelte-1gisas9");
    			add_location(button0, file$3, 133, 2, 4737);
    			attr_dev(button1, "id", "ButtonPredict");
    			attr_dev(button1, "class", "svelte-1gisas9");
    			add_location(button1, file$3, 134, 2, 4800);
    			add_location(div1, file$3, 131, 0, 4708);
    			add_location(div2, file$3, 120, 0, 4279);
    			attr_dev(div3, "id", "tabbar");
    			attr_dev(div3, "class", "svelte-1gisas9");
    			add_location(div3, file$3, 119, 0, 4261);
    			attr_dev(body, "id", "pagePrediction");
    			attr_dev(body, "class", "svelte-1gisas9");
    			add_location(body, file$3, 118, 0, 4234);
    			add_location(main, file$3, 117, 0, 4226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(modelselector, div1, null);
    			append_dev(div1, t15);
    		...
    		p: function update(ctx, [dirty]) {
    			if ((!current || dirty & /*$predictionPercentage, predictedAnswer*/ 17) && t12_value !== (t12_value = (/*$predictionPercentage*/ ctx[0][/*predictedAnswer*/ ctx[4]]
    			? `Probability: ${/*$predictionPercentage*/ ctx[0][/*predictedAnswer*/ ctx[4]]}%`
    			: '') + "")) set_data_dev(t12, t12_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(modelselector.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(modelselector.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			...
    			destroy_component(modelselector);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	validate_store(selectedModel, 'selectedModel');
    	component_subscribe($$self, selectedModel, $$value => $$invalidate(14, $selectedModel = $$value));
    	...
    	onMount(() => {
    		...
    		function predict() {
    			canvas.toBlob(function (blob) {
    				...
    				fetch('http://127.0.0.1:8000/model_v1/predict/' + $selectedModel, { method: 'POST', body: formData }).then(res => {
    					return res.json();
    				}).then(data => {
    ...
    // (18:6) {#each Object.entries($predictionPercentage) as [number, percentage]}
    function create_each_block(ctx) {
    	let tr;
    	let th;
    	let t0_value = /*number*/ ctx[2] + "";
    	let t0;
    	let t1;
    	let td;
    	let span;
    	let t2_value = /*percentage*/ ctx[3] + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(th, "class", "svelte-1knitlg");
    			add_location(th, file$2, 19, 10, 822);
    			attr_dev(span, "class", "svelte-1knitlg");
    			add_location(span, file$2, 21, 12, 879);
    			attr_dev(td, "class", "svelte-1knitlg");
    			add_location(td, file$2, 20, 10, 862);
    			set_style(tr, "height", /*percentage*/ ctx[3] + "%");
    			attr_dev(tr, "class", "svelte-1knitlg");
    			add_location(tr, file$2, 18, 8, 778);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$predictionPercentage*/ 1 && t0_value !== (t0_value = /*number*/ ctx[2] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*$predictionPercentage*/ 1 && t2_value !== (t2_value = /*percentage*/ ctx[3] + "")) set_data_dev(t2, t2_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(18:6) {#each Object.entries($predictionPercentage) as [number, percentage]}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(link0, "rel", "stylesheet");
    			add_location(link0, file$2, 5, 0, 169);
    			attr_dev(link1, "href", "https://fonts.googleapis.com/css2?family=Bebas+Neue&display=swap");
    			attr_dev(link1, "rel", "stylesheet");
    			add_location(link1, file$2, 6, 0, 326);
    			attr_dev(caption, "id", "colorfont");
    			attr_dev(caption, "class", "svelte-1knitlg");
    			add_location(caption, file$2, 9, 4, 470);
    			attr_dev(th0, "scope", "col");
    			attr_dev(th0, "class", "svelte-1knitlg");
    			add_location(th0, file$2, 12, 8, 564);
    			attr_dev(th1, "scope", "col");
    			attr_dev(th1, "class", "svelte-1knitlg");
    			add_location(th1, file$2, 13, 8, 598);
    			attr_dev(tr, "class", "svelte-1knitlg");
    			add_location(tr, file$2, 11, 6, 551);
    			attr_dev(thead, "class", "svelte-1knitlg");
    			add_location(thead, file$2, 10, 4, 537);
    			attr_dev(tbody, "class", "horizontal svelte-1knitlg");
    			attr_dev(tbody, "id", "pageG");
    			add_location(tbody, file$2, 16, 4, 656);
    			attr_dev(table, "class", "graph svelte-1knitlg");
    			add_location(table, file$2, 8, 2, 443);
    			attr_dev(h1, "id", "font");
    			attr_dev(h1, "class", "svelte-1knitlg");
    			add_location(h1, file$2, 27, 47, 1020);
    			attr_dev(button, "id", "backButton");
    			attr_dev(button, "class", "svelte-1knitlg");
    			add_location(button, file$2, 27, 2, 975);
    			attr_dev(main, "id", "BGpage");
    			attr_dev(main, "class", "svelte-1knitlg");
    			add_location(main, file$2, 7, 0, 422);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*onBackBtn*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [$predictionPercentage, onBackBtn];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1uizfvh");
    			add_location(h1, file$1, 10, 2, 525);
    			attr_dev(div, "id", "box");
    			attr_dev(div, "class", "svelte-1uizfvh");
    			add_location(div, file$1, 9, 2, 508);
    			attr_dev(button, "id", "ButtonGraph");
    			attr_dev(button, "class", "svelte-1uizfvh");
    ...
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(13:1) {#if $togglePredicted}",
    		ctx
    	});
