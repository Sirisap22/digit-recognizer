    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div3, "class", "svelte-1df3cv");
    			add_location(div3, file$3, 119, 0, 4261);
    			attr_dev(body, "id", "pagePrediction");
    			attr_dev(body, "class", "svelte-1df3cv");
