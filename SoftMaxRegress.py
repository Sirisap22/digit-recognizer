...
training = pd.read_csv("D:/work/3DS1/Linear/DigiReg/kaggle/input/digit-recognizer/train.csv")
testing = pd.read_csv("D:/work/3DS1/Linear/DigiReg/kaggle/input/digit-recognizer/test.csv")
